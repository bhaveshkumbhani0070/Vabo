...
exports.logout = function (req, res)
{
    ...
    logger.info('*** Requested for Logout	***');
...
{
    console.log("*** Requested for change availability of user ***");
    logger.info('*** Requested for change availability of user ***');
...
{
    console.log("*** Requested for RegisterDevice ***");
    logger.info('*** Requested for RegisterDevice ***');
    receivedValues = req.body //RESPONSE FROM WEB
    if (JSON.stringify(receivedValues) === '{}')
    {
        Errors.EmptyBody(res);
...
{
    console.log("*** Requesting for View Message ***");
    logger.info('*** Requesting for View Message ***');
...
{
    console.log("*** Requested for Read Message ***");
    logger.info('*** Requested for Read Message ***');
    receivedValues = req.body    //DATA FROM WEB
    if (JSON.stringify(receivedValues) === '{}')
    {
        Errors.EmptyBody(res);
...
{
    console.log("*** Requested for Send Message ***");
    logger.info('*** Requested for Send Message ***');
    receivedValues = req.body    //DATA FROM WEB
    if (JSON.stringify(receivedValues) === '{}')
    {
        Errors.EmptyBody(res);
...
{
    console.log("*** Requested for Reset Password... ***");
...
{
    console.log("*** Requested for ForgotPassword... ***");
...
{
    console.log("*** Requested for changePassword... ***");
    logger.info('*** Requested for changePassword... ***');
    receivedValues = req.body //RESPONSE FROM WEB
...
{
    console.log("*** Requested for Get User Details... ***");
    logger.info('*** Requested for Get User Details... ***');
    pool.getConnection(function (err, connection) {
        if (err)
        {
            Errors.Connection_Error(res);

...
{
    console.log("*** Requested for Creating New Service... ***");
    logger.info('*** Requested for Creating New Service... ***');
...
{
    console.log("*** Requested for Selecting Service ***");
    logger.info('*** Requested for Selecting Service ***');
    pool.getConnection(function(err,connection){
        if(err)
        {
            Errors.Connection_Error(res);
...
{
    console.log("*** Requested for Listing Service ***");
    logger.info('*** Requested for Listing Service ***');
    pool.getConnection(function(err,connection){
        if(err)
        {
            Errors.Connection_Error(res);
...
{
    console.log("*** Requesting for Editing Service ***");
    logger.info('*** Requesting for Editing Service ***');
    receivedValues = req.body    //DATA FROM WEB
    if(JSON.stringify(receivedValues) === '{}')
    {
        Errors.EmptyBody(res);
...
{
    console.log("*** Requesting for Deleting Service ***");
    logger.info('*** Requesting for Deleting Service ***');

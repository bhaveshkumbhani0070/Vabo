...
{
	console.log('*** Staging Requested for Get Quetions and Answer ***');
	logger.info('*** Staging Requested for Get Quetions and Answer ***');
...
{
		console.log("*** Staging Requested for Appointment Help ***");
		logger.info('*** Staging Requested for Appointment Help	***');
